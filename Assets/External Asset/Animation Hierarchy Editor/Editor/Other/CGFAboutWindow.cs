...
namespace CGF.Editor.Other
{
    ...
    internal class CGFAboutWindow : EditorWindow
    {
        ...
        private const string name_01 = "Pau Elias Soriano - Producer, Shader programmer and Designer";

        private const string name_02 = "David Cuenca Diez - Programmer and Designer";
        ...
        public void OnGUI()
        {
            ...
            GUILayout.Label(CGFLogo, GUIStyle.none, GUILayout.Width(450), GUILayout.Height(74));
            ...
            GUILayout.TextArea(name_01 + Environment.NewLine + name_02, GUI.skin.label);
            ...
            GUILayout.Label("Copyright (C) 2020 Chloroplast Games. All rights reserved. Property of ChloroSoft.",
                "MiniLabel");
