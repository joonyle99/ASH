...
public class TutorialZone : TriggerZone
{
    ...
    private void Awake()
    {
        _displayReplaceKeyCode.Add(KeyCode.RightArrow, "→");
        _displayReplaceKeyCode.Add(KeyCode.LeftArrow, "←");
        _displayReplaceKeyCode.Add(KeyCode.UpArrow, "↑");
        _displayReplaceKeyCode.Add(KeyCode.DownArrow, "↓");
