...
namespace CGF.Editor.Tools
{
    public class PathData
    {
        ...
        public PathData(string clipName, string currentPath, string lastPath, EditorCurveBinding editorCurve)
        {
            ClipName = clipName;
    ...
    public class CGFAnimationHierarchyEditorTool : EditorWindow
    {
        ...
        private void FillModel()
        {
            ...
            try
            {
                ...
                {
                    var pathDataListByClip = FillModelWithCurves(currentAnimationClip.name, AnimationUtility.GetCurveBindings(currentAnimationClip));
        ...
        private List<PathData> FillModelWithCurves(string clipName, EditorCurveBinding[] curves)
        {
            ...
            foreach (var curve in curves)
            {
                ...
                {
                    pathDataList.Add(new PathData(clipName, curve.path, curve.path, curve));
                }
            }
        ...
        private void UpdatePath(PathData pathData)
        {
            ...
            foreach (var currentAnimationClip in _currentAnimationClips)
            {
                AnimationClip animationClip = currentAnimationClip;
